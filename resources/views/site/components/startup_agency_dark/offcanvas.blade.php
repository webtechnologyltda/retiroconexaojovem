    ...
    <div class="tp-offcanvas offcanvas-black-bg">
        <div class="tp-offcanvas-top d-flex align-items-center justify-content-between">
            <div class="tp-offcanvas-logo">
                <a href="{{ asset('aleric/index.html') }}">
                    <img data-width="150" src="{{ asset('aleric/assets/img/logo/logo-white-2.png') }}" alt="logo">
                </a>
            </div>
            ...
            <div class="row gx-2">
                <div class="col-md-3 col-3">
                    <div class="tp-offcanvas-gallery-img fix">
                        <a class="popup-image" href="{{ asset('aleric/assets/img/offcanvas/offcanvas-1.jpg') }}"><img src="{{ asset('aleric/assets/img/offcanvas/offcanvas-1.jpg') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-md-3 col-3">
                    <div class="tp-offcanvas-gallery-img fix">
                        <a class="popup-image" href="{{ asset('aleric/assets/img/offcanvas/offcanvas-2.jpg') }}"><img src="{{ asset('aleric/assets/img/offcanvas/offcanvas-2.jpg') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-md-3 col-3">
                    <div class="tp-offcanvas-gallery-img fix">
                        <a class="popup-image" href="{{ asset('aleric/assets/img/offcanvas/offcanvas-3.jpg') }}"><img src="{{ asset('aleric/assets/img/offcanvas/offcanvas-3.jpg') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-md-3 col-3">
                    <div class="tp-offcanvas-gallery-img fix">
                        <a class="popup-image" href="{{ asset('aleric/assets/img/offcanvas/offcanvas-4.jpg') }}"><img src="{{ asset('aleric/assets/img/offcanvas/offcanvas-4.jpg') }}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
